...
Welcome to the iOS Bootcamp! Please follow these steps to set up your project:

1. Clone this repository to your local machine.
2. Create and switch to a new branch named after your **UnityID** to ensure your work is tracked individually.
